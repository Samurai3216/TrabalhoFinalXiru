...
public class TelaLogin extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        ftxtKeyword.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                ftxtKeywordActionPerformed(evt);
            }
        });
    ...
    private void btnLoginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLoginActionPerformed
        ...
        // Verifica�ao dos dados inscritos na tela 
        ...
        try {
            dao = new UsuarioDAO();
            if (dao.verificarLoginSenha(login, password)) {
            ...
            Logger.getLogger(TelaLogin.class.getName()).log(Level.SEVERE, null,
                    ex);
        }
    ...
    private void ftxtKeywordActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ftxtKeywordActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_ftxtKeywordActionPerformed
